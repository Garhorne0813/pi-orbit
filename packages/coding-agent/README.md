...
Pi runs in five modes: interactive, print, JSON, RPC for process integration, and Web for HTTP/WebSocket clients. It also provides an SDK for embedding in your own apps.
